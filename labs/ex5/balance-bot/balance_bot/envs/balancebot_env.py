...
class BalancebotEnv(gym.Env):
    ...
    def __init__(self, render=False):
        ...
        # observation encodes pitch, gyro, angular velocity of the wheels
        self.observation = []
    ...
    def reset(self):
        self.vt = 0  # current velocity of the wheels
        self.maxV = 24.6  # max velocity, 235RPM = 24.609142453 rad/sec
